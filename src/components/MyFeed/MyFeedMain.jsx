            ...
            <section>
                <div className='MfWrap'>
                    <div className='header-profile'>
                        ...
                        <div className='profile-main'>
                            ...
                            <ul className='fol-amount mb20'>
                                ...
                                <li><Link to='following'>팔로잉<span>100</span></Link></li>
                            </ul>
                            <Routes>
                    ...
                    <div className='feed-cate'>
                        <Link to='/profile' className={`cate-btn ${feeds ? 'active' : ''}`} id='feeds' onClick={tabClick}>
                            <div>게시물</div>
                        </Link>
