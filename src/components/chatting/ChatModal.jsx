...
export default function ChatModal({match}) {
  ...
  stompClient.current.publish({destination: `/pub/chat/m`, body: JSON.stringify({vData
  })});
};
  // 메시지 전송 데이터
  // const lastMsgTime = new Date().toLocaleDateString() 
  const vData = {
    myId : 21,
    toUserId : 22,
    roomId : 2122,
  ...
  //   const response = await wouteAPI(`/chat/${currentId}`, 'GET');
  ...
  // console.log('msg' + receiveMessage);
          ...
          <div className="chat-inner">
            <div className="chat-util">
              ...
              <div className="chatRoom-list">
                ...
                {/* 로그인 값 가져오면 */}
                <NavLink to='/chat/m/1' onClick={roomHeader} state={{ backgroundLocation: state}} className="chat-tab" >
                {/* <NavLink to={`/chat/${currentId}/m/1`} onClick={roomHeader} state={{ backgroundLocation: location}} className="chat-tab" > */}
                  <div className="profileImg">
                    <img
                      src="https://img.sportsworldi.com/content/image/2023/06/08/20230608510214.jpg"
                      alt="상대 프로필"
                    />
                  </div>
                  <div className="profileInfo">
                    ...
                    <div className="tab-last">마지막 챗</div>
                  </div>
                  <div className="chat-noti">
                    <div>
                        <div className="noti-dot"></div>
                ...
                <NavLink to='m/2' className="chat-tab">
                  <div className="profileImg">
                    <img
                      src="data:image/jpeg;base64,"
                      alt="상대 프로필"
            ...
            {
              // location.pathname === `/chat/${currentId}` ? 
                  ...
                  <div className="chat-service">
                    <div className="chat-log">
                      <div className="logList-wrap">
                        <Routes>
                          {/* 백 로그인 값 가져오면 */}
                          <Route path="/chat/m/1"  element={<ChatRoom data={receiveMessage}/>} />
                          {/* <Route path={`/chat/${currentId}/m/1}`}  element={<ChatRoom data={receiveMessage}/>} /> */}
                        </Routes>
                      </div>
                    </div>
